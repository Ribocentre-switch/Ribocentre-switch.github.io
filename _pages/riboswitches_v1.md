...
<div class="form-container">
  ...
  <select id="downloadOptions">
    ...
    <option value="path/to/your/excel1.xlsx">Cofactors</option>
    <option value="path/to/your/excel2.xlsx">RNA derivatives</option>
    <option value="path/to/your/excel3.xlsx">RNA precursors</option>
    <option value="path/to/your/excel3.xlsx">Signaling molecules</option>
    <option value="path/to/your/excel3.xlsx">Elemental ions</option>
    <option value="path/to/your/excel3.xlsx">Amino acids</option>
    <option value="path/to/your/excel3.xlsx">Sugars</option>
    <option value="path/to/your/excel3.xlsx">T-box</option>
    <option value="path/to/your/excel3.xlsx">Others</option>
    <option value="path/to/your/excel3.xlsx">all</option>
  </select>
  <!-- Download button -->
