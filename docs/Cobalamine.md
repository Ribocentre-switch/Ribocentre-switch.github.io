...
<p style="font-size: 24px"><strong>&emsp;&emsp;&emsp;&emsp;[RF00174](https://rfam.xfam.org/family/RF00174,target="_blank")</strong> (Cobalamin riboswitch) <br /></p>
<p style="font-size: 24px"><strong>&emsp;&emsp;&emsp;&emsp;[RF01689](https://rfam.xfam.org/family/RF01689,target="_blank")</strong> (AdoCbl variant RNA) <br /></p>
                    ...
                    <td class="left" style="border: none; padding: 0; vertical-align: top">
                        <div class="image-wrapper" style="margin-bottom: 40px;">
                            ...
                            <div class="button-wrapper">
                                <a class="btn " href="javascript:showImage0('/images/2D/AdoCbl_riboswitch_2D1.svg');">&lt;&lt; Show big</a>
                            </div>
                        </div>
                        <div class="image-wrapper" >
                            ...
                            <div class="button-wrapper">
                                <a class="btn " href="javascript:showImage0('/images/2D/AdoCbl_riboswitch_2D2.svg');">&lt;&lt; Show big</a>
                            </div>
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="left" style="border: none; padding: 0; vertical-align: top">
                        <div class="image-wrapper" style="margin-bottom: 40px;">
                            ...
                            <div class="button-wrapper">
                                <a class="btn " href="javascript:showImage1('/images/2D/AqCbl_riboswitch_2D1.svg');">&lt;&lt; Show big</a>
                            </div>
                        </div>
                        <div class="image-wrapper" >
                            ...
                            <div class="button-wrapper">
                                <a class="btn " href="javascript:showImage1('/images/2D/AqCbl_riboswitch_2D2.svg');">&lt;&lt; Show big</a>
                            </div>
                        </div>
                    </td>
                </tr>
...
<div ><p style="text-align:right;margin-bottom: 0px;">Need helps</p>
  <table class="table table-bordered" style="table-layout:fixed;width:1000px;margin-left:auto;margin-right:auto;"><tr>
  <td style="text-align:center;padding-bottom: 0px;padding-left: 0px;padding-top: 0px;padding-right: 0px">
