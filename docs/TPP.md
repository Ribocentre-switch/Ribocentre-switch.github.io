...
permalink: /docs/TPP/
---
**Rfam ID: [RF00059](https://rfam.xfam.org/family/RF00059)(TPP riboswitch (THI element))** <br>
...
<div class="timeline">
  ...
  <ul class="days">
    ...
    <li class="day">
     <div class="events">
       <p style="width: 380px;">Discovery of Thi-box conserved RNA structure in bacteria</p>
    ...
    <li class="day">
     <div class="events">
       <p style="padding-left: 30px;">Validation of TPP riboswitch in <i>Escherichia coli</i></p>
    ...
    <li class="day">
     <div class="events">
       <p style="width: 380px;">Validation of TPP riboswitch in fungi and in plants</p>
    ...
    <li class="day">
     <div class="events">
       <p style="padding-left: 30px;">Important roles of Mg<sup>2+</sup> in TPP riboswitch</p>
    ...
    <li class="day">
     <div class="events">
       <p style="width: 380px;">TPP riboswitches are targets for the antimicrobial compound pyrithiamine</p>
    ...
    <li class="day">
     <div class="events">
       <p style="padding-left: 30px;">Crystal structure of the eukaryotic TPP riboswitch</p>
    ...
    <li class="day">
     <div class="events">
       <p style="width: 380px;">Crystal structure of the prokaryotic TPP riboswitch</p>
    ...
    <li class="day">
     <div class="events">
       <p style="padding-left: 30px;">Crystal structures of the <i>E.coli thiM</i> TPP riboswitch bound to TPP and its analogs</p>
    ...
    <li class="day">
     <div class="events">
       <p style="width: 380px;">Crystal structures of the eukaryotic TPP riboswitch bound to OTPP and PTPP</p>
    ...
    <li class="day">
     <div class="events">
       <p style="padding-left: 30px;">Subsite ligand cooperativity and fragment-linking strategies in TPP riboswitch</p>
    ...
    <li class="day">
     <div class="events">
       <p style="width: 380px;">Small molecule fragments discovery and linked-fragment ligand design in TPP riboswitch</p>
    ...
    <div class="main-container">
        <div class="zoom-wrapper1">
            <div class="zoom-area1">
                <img src="/images/2D/TPP_riboswitch_2D1.svg" alt="drawing" style="width:400px" />
            </div>
        </div>
    </div>
    ...
    <div class="main-container">
        <div class="zoom-wrapper2">
            <div class="zoom-area2">
                <img src="/images/2D/TPP_riboswitch_2D2.svg" alt="drawing" style="width:400px" />
            </div>
        </div>
    </div>
    <script src="https://www.ribocentre.org/js/panzoom.js"></script>
...
<font size=4>
<p>Chemical structures of TPP and its analogs. The apparent K<sub>D</sub> of each compound is shown on bottom<sup>[3,8-10,22-23]</sup>.<br /><br /></p>
</font>
<table class="table table-bordered" style="table-layout:fixed;width:800px;margin-left:auto;margin-right:auto;">
<tr>
<td style="text-align:center;padding-bottom: 0px;padding-left: 0px;padding-top: 0px;padding-right: 0px">
