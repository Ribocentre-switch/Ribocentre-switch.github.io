...
---
**Rfam ID: [RF00522](https://rfam.xfam.org/family/RF00522)(PreQ<sub>1</sub>-I riboswitch)** <br>
&emsp;&emsp;&emsp;&emsp;**[RF01054](https://rfam.xfam.org/family/RF01054)(PreQ<sub>1</sub>-II riboswitch)** <br>
&emsp;&emsp;&emsp;&emsp;**[RF02680](https://rfam.xfam.org/family/RF02680)(PreQ<sub>1</sub>-III riboswitch)** <br>
...
<div class="timeline">
  ...
  <ul class="days">
    ...
    <li class="day">
     <div class="events">
       <p style="width: 380px;">Discovery of preQ<sub>1</sub>-I riboswitch</p>
    ...
    <li class="day">
     <div class="events">
       <p style="padding-left: 30px;">Discovery of preQ<sub>1</sub>-II riboswitch</p>
    ...
    <li class="day">
     <div class="events">
       <p style="width: 380px;">Crystal structures of the preQ<sub>1</sub>-I type 2 riboswitch bound to preQ<sub>1</sub></p>
    ...
    <li class="day">
     <div class="events">
       <p style="padding-left: 30px;">NMR solution studies of preQ<sub>1</sub>-I type 2 riboswitch bound to preQ<sub>1</sub></p>
    ...
    <li class="day">
     <div class="events">
       <p style="width: 380px;">Crystal structures of the preQ<sub>1</sub>-I type 1 riboswitch bound to preQ<sub>0</sub></p>
    ...
    <li class="day">
     <div class="events">
       <p style="padding-left: 30px;">Crystal structures of the preQ<sub>1</sub> type 2 riboswitch in the preQ<sub>1</sub>-bound and free states</p>
    ...
    <li class="day">
     <div class="events">
       <p style="width: 380px;">Crystal structures of the preQ<sub>1</sub>-II riboswitch bound to preQ<sub>1</sub></p>
    ...
    <li class="day">
     <div class="events">
       <p style="padding-left: 30px;">NMR solution studies of preQ<sub>1</sub>-II riboswitch bound to preQ<sub>1</sub></p>
    ...
    <li class="day">
     <div class="events">
       <p style="width: 380px;">Discovery of preQ<sub>1</sub>-I type3 riboswitch and preQ<sub>1</sub>-III riboswitch</p>
    ...
    <li class="day">
     <div class="events">
       <p style="padding-left: 30px;">Crystal structures of the preQ<sub>1</sub>-III riboswitch bound to preQ<sub>1</sub></p>
    ...
    <li class="day">
     <div class="events">
       <p style="width: 380px;">long-range stacking spine in preQ<sub>1</sub>-I type 2 riboswitche that links effector binding to the expression platform</p>
    ...
    <li class="day">
     <div class="events">
       <p style="padding-left: 30px;">Crystal structures of preQ<sub>1</sub>-I riboswitch bound to two preQ<sub>1</sub> ligands in a single binding pocket</p>
...
<td style="text-align:center;padding-bottom: 0px;padding-left: 0px;padding-top: 0px;padding-right: 0px">
  <img src="/images/gene_association/PreQ1_riboswitch_gene_association" alt="drawing" style="width:800px;margin-top: 0px;margin-bottom: 0px;" >
</td>
</tr>
</table>
<p><br /></p>
