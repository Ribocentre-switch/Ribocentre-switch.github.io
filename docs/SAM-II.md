...
permalink: /docs/SAM/
---
**Rfam ID: [RF00521](https://rfam.xfam.org/family/RF00521)(SAM riboswitch (alpha-proteobacteria)
)** <br>
...
<div class="timeline">
  ...
  <ul class="days">
    ...
    <li class="day">
     <div class="events">
       <p style="width: 380px;">Discovery of SAM-II riboswitch</p>
    ...
    <li class="day">
     <div class="events">
       <p style="padding-left: 30px;">Crystalline structure of the SAM-II riboswitch</p>
    ...
    <li class="day">
     <div class="events">
       <p style="width: 380px;">Discovery of SAM-V riboswitch</p>
    ...
    <li class="day">
     <div class="events">
       <p style="padding-left: 30px;">Described SAM-V riboswitch carefully for the first time.</p>
    ...
    <li class="day">
     <div class="events">
       <p style="width: 380px;">Explored the ligand-induced folding process of the S-adenosylmethionine type II</p>
    ...
    <li class="day">
     <div class="events">
       <p style="padding-left: 30px;">The conformational state of the structure is explained</p>
    ...
    <li class="day">
     <div class="events">
       <p style="width: 380px;">Metabolite recognition and specificity of the SAM-II riboswitch</p>
    ...
    <li class="day">
     <div class="events">
       <p style="padding-left: 30px;">Study on the folding mechanism of proteobacteria SAM-II riboswitch by molecular dynamics</p>
    ...
    <li class="day">
     <div class="events">
       <p style="width: 380px;">SAM-II Riboswitch Samples at least Two Conformations in Solution</p>
    ...
    <li class="day">
     <div class="events">
       <p style="padding-left: 30px;">Effect of magnesium ion on preorganized SAM-II</p>
    ...
    <li class="day">
     <div class="events">
       <p style="width: 380px;">solved the X-ray structure of SAM-V riboswitch</p>
...
<font size="4"><p>Potential mechanism of translation regulation by the SAM-II riboswitch and SAM-V riboswitch<sup>[7,12]</sup>.</p></font>
<table class="table table-bordered" style="table-layout:fixed;width:800px;margin-left:auto;margin-right:auto;"><tr>
  <td style="text-align:center;padding-bottom: 0px;padding-left: 0px;padding-top: 0px;padding-right: 0px">
  <img src="/images/gene_regulation/SAM-II_riboswitch_gene_regulation.svg" alt="drawing" style="width:400px;margin-top: 0px;margin-bottom: 0px;" >
  </td>
</tr>
</table>
<p><br /></p>
