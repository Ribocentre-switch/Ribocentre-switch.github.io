...
},
{
  ...
  color:{r:255,g:11,b:12}
          ...
          <button button style="float: left;height:25px;width: 120px;" onclick="viewerInstance1.visual.clearSelection()">Clear Selection</button><br><br>
           <button button style="float: left;height:25px;width: 120px;" onclick="loadScript()">Load Script</button>
      </div>
    ...
    <script>
      ...
      function loadScript() {
        ...
        script.src = 'https://www.ebi.ac.uk/pdbe/pdb-component-library/js/pdbe-molstar-plugin-1.2.1.js';
