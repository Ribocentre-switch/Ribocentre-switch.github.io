...
---
<p style="font-size: 24px"><strong>Rfam ID: [RF00504](https://rfam.xfam.org/family/RF00504)(Glycine riboswitch)</strong> <br /></p>
...
<div class="timeline">
  ...
  <ul class="days">
    ...
    <li class="day">
     <div class="events">
       <p >The engineering of a glycine riboswitch to control a Novel Metabolic Pathway for 5‑Aminolevulinic Acid Production in Escherichia coli</p>
    ...
    <li class="day">
     <div class="events">
       <p >The synthetic glycine-ON and -OFF riboswitches for metabolic regulation in Escherichia coli</p>
