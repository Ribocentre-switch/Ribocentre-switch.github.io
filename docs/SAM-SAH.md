...
<div class="timeline">
  ...
  <ul class="days">
    ...
    <li class="day">
     <div class="events">
       <p style="width: 380px;">Discovery of SAM-SAH riboswitch</p>
    ...
    <li class="day">
     <div class="events">
       <p style="padding-left: 30px;">the NMR resonance assignment of the SAM/SAH binding riboswitch (env9b) in complex with SAH</p>
    ...
    <li class="day">
     <div class="events">
       <p style="width: 380px;">NMR structure of the SAM/SAH-binding riboswitch</p>
    ...
    <li class="day">
     <div class="events">
       <p style="padding-left: 30px;">Crystal structure of the SAM/SAH riboswitch</p>
    ...
    <li class="day">
     <div class="events">
       <p style="width: 380px;">Mg <sup>2+</sup> plays vital roles in SAM/SAH riboswitch function.</p>
...
<td style="text-align:center;padding-bottom: 0px;padding-left: 0px;padding-top: 0px;padding-right: 0px">
  <img src="/images/gene_association/SAM-SAH riboswitch_gene_association.svg" alt="drawing" style="width:800px;margin-top: 0px;margin-bottom: 0px;" >
</td>
</tr>
</table>
<p><br /></p>
...
<table class="table table-bordered" style="table-layout:fixed;width:800px;margin-left:auto;margin-right:auto;"><tr>
  <td style="text-align:center;padding-bottom: 0px;padding-left: 0px;padding-top: 0px;padding-right: 0px">
  <img src="/images/gene_regulation/SAM-SAH_riboswitch_gene_regulation.svg" alt="drawing" style="width:400px;margin-top: 0px;margin-bottom: 0px;" >
  </td>
</tr>
</table>
<p><br /></p>
...
<tr>
<td style="text-align:center;padding-bottom: 0px;padding-left: 0px;padding-top: 0px;padding-right: 0px">
  <img src="/images/ligand_recognition/SAM-SAH_riboswitch_ligand_recognition.svg" alt="drawing" style="width:800px;margin-top: 0px;margin-bottom: 0px;" >
</td>
</tr>
</table>
<p><br /></p>
