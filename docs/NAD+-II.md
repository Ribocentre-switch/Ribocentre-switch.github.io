...
<div class="timeline">
  ...
  <ul class="days">
    ...
    <li class="day">
     <div class="events">
       <p style="width: 380px;">Discovery of NAD<sup>+</sup>-II riboswitch</p>
    ...
    <li class="day">
     <div class="events">
       <p style="padding-left: 30px;">Biochemical validation of NAD<sup>+</sup>-II riboswitch</p>
    ...
    <li class="day">
     <div class="events">
       <p style="width: 380px;">Crystal structure of NAD<sup>+</sup>-II riboswitch</p>
    ...
    <li class="day">
     <div class="events">
       <p style="padding-left: 30px;">Crystal structure of NAD<sup>+</sup>-II riboswitch reveal two distinct ligand-binding pockets</p>
