...
---
**Rfam ID: [RF00234](https://rfam.xfam.org/family/RF00234)(glmS glucosamine-6-phosphate activated ribozyme)** <br>
...
<div class="timeline">
  ...
  <ul class="days">
    ...
    <li class="day">
     <div class="events">
       <p style="width: 380px;">Discovery,Secondary structure of the GlcN6P riboswitch</p>
    ...
    <li class="day">
     <div class="events">
       <p style="padding-left: 30px;">The gene regulation of GlcN6P</p>
    ...
    <li class="day">
     <div class="events">
       <p style="width: 380px;">Location of ligand-binding site</p>
    ...
    <li class="day">
     <div class="events">
       <p style="padding-left: 30px;">3D structure with glucosamine-6-phosphate</p>
    ...
    <li class="day">
     <div class="events">
       <p style="width: 380px;">3D structure with divalent metal ions</p>
    ...
    <li class="day">
     <div class="events">
       <p style="padding-left: 30px;">Pseudoknot structure</p>
    ...
    <li class="day">
     <div class="events">
       <p style="width: 380px;">Chemical Mechanism</p>
    ...
    <li class="day">
     <div class="events">
       <p style="padding-left: 30px;">signals from activating and inhibitory metabolites</p>
    ...
    <li class="day">
     <div class="events">
       <p style="width: 380px;">GlcN6P-like molecules for their ability to support self-cleavage</p>
    ...
    <li class="day">
     <div class="events">
       <p style="padding-left: 30px;">Catalytic Mechanism</p>
    ...
    <li class="day">
     <div class="events">
       <p style="width: 380px;">Gene association</p>
    ...
    <li class="day">
     <div class="events">
       <p style="padding-left: 30px;">As a target for antibacterial drug development</p>
...
<td style="text-align:center;padding-bottom: 0px;padding-left: 0px;padding-top: 0px;padding-right: 0px">
  <img src="/images/gene_association/GlcN6P_riboswitch_gene_regulation.svg" alt="drawing" style="width:800px;margin-top: 0px;margin-bottom: 0px;" >
</td>
</tr>
</table>
<p><br /></p>
...
<font size=4><p>Left: Surface representation of the binding pocket of the GlcN6P riboswitch generated from PDB ID: 2H0Z. The glucose-6-phosphate (<i>G6P</i>, depicted in sticks) and Mg<sup>2+</sup> (<i>M</i> depicted in sphere) were highlighted in red. Right: The hydrogen bonds of the binding sites of the GlcN6P riboswitch bound with <i>G6P,M</i><sup>[4]</sup>.<br /></p></font>
<table class="table table-bordered" style="table-layout:fixed;width:800px;margin-left:auto;margin-right:auto;"><tr>
...
<tr>
<td style="text-align:center;padding-bottom: 0px;padding-left: 0px;padding-top: 0px;padding-right: 0px">
  <img src="/images/ligand_recognition/GlcN6P_riboswitch_ligand_recognition.svg" alt="drawing" style="width:800px;margin-top: 0px;margin-bottom: 0px;" >
</td>
</tr>
</table>
<p><br /></p>
